...
class IxNet:
    ...
    def _CheckClientVersion (self):
        if self._version != self.getVersion():
            print("WARNING: IxNetwork Python library version %s is not matching the IxNetwork client version %s" % (self._version, self.getVersion()))
